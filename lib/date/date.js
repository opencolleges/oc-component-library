...
export default class Date extends React.Component {
  ...
  render() {
    ...
    state.error && (classNames += ` ${namespace('date--error')}`);
    state.success && (classNames += ` ${namespace('date--success')}`);
    ...
    return (
      <div className={classNames} style={props.style}>
        ...
        {!props.readOnly && <Icon modifiers="icon--calendar active" />}
            ...
            <ul className={namespace('date__list')}>
              {isInDateRange(getEndOfMonth(state.calendar.months[0].date)) ? (
                <li
                  ...
                  <Icon modifiers="icon--chevron-left active" />
                </li>
              ) : (
                <li
                  className={namespace(
                  ...
                  <Icon modifiers="icon--chevron-left" />
                </li>
              )}
              ...
              {isInDateRange(getStartOfMonth(state.calendar.months[2].date)) ? (
                <li
                  ...
                  onMouseDown={handleMouseDown}
                  onTouchEnd={handleMouseDown}>
                  <Icon modifiers="icon--chevron-right active" />
                </li>
              ) : (
                <li
                  className={namespace(
                  ...
                  <Icon modifiers="icon--chevron-right" />
                </li>
              )}
