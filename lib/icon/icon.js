...
// * React component
const OCIcon = ({ modifiers, className, style, size }) => {
  ...
  return (
    <svg
      ...
      {find('icon--question-ring', modifiers) && <QuestionRing />}
...
const QuestionRing = () => {
  return (
    <g>
      ...
      />
      <path className={prefix('stroke stroke--3')} d="M12,17 L12,18" />
    </g>
  );
};
...
const PlusRing = () => {
  return (
    <g>
      <circle className={prefix('stroke stroke--1')} cx="12" cy="12" r="9.5" />
      <path className={prefix('stroke stroke--2')} d="M7,12 L17,12" />
      <path className={prefix('stroke stroke--3')} d="M12,7 L12,17" />
    </g>
  );
};
...
const Print = () => {
  return (
    <g>
      ...
      />
      <path className={prefix('stroke stroke--4')} d="M9 16.5L15 16.5" />
      <path className={prefix('stroke stroke--5')} d="M9 18.5L15 18.5" />
    </g>
  );
};
