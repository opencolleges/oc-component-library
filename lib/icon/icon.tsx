...
const Icon: React.FC<Props> = (props: Props) => {
  ...
  return (
    <svg
      ...
      aria-hidden="true">
      {React.createElement(iconTypes[props.type], {})}
    </svg>
  );
};
...
const ArrowUp: React.FC = () => {
  const BEM_MODULE: BEMInterface = BEM(`stroke`);
  const { getModifier, getResult }: BEMInterface = BEM_MODULE;

  return (
    <React.Fragment>
      <path
        className={`${getResult()} ${getModifier(`1`)}`}
        d="M12,20 L12,4.71"
      />
      <polyline
        className={`${getResult()} ${getModifier(`2`)}`}
...
const Calendar: React.FC = () => {
  ...
  return (
    <React.Fragment>
      ...
      />
      <path
        className={`${getResult()} ${getModifier(`3`)}`}
        d="M7.5,4.5 L7.5,2"
      />
      <path
        className={`${getResult()} ${getModifier(`4`)}`}
        d="M16.5,4.5 L16.5,2"
      />
    </React.Fragment>
  );
...
const Draggable: React.FC = () => {
  ...
  return (
    <React.Fragment>
      ...
      />
      <circle
        className={`${getResult()} ${getModifier(`5`)}`}
        cx="8"
        cy="20"
        r="2"
      />
      <circle
        className={`${getResult()} ${getModifier(`6`)}`}
        cx="16"
        cy="20"
        r="2"
      />
  ...
  return (
    <React.Fragment>
      <path
        ...
        d="M0,4.5 L24,4.5"
      />
      <path className={`${getResult()} ${getModifier(`2`)}`} d="M0,12 L24,12" />
      <path
        className={`${getResult()} ${getModifier(`3`)}`}
        d="M0,19.5 L24,19.5"
      />
...
const Minus: React.FC = () => {
  ...
  return (
    <React.Fragment>
      <path className={`${getResult()} ${getModifier(`1`)}`} d="M4,12 L20,12" />
    </React.Fragment>
  );
};
  ...
  return (
    <React.Fragment>
      <circle
        ...
        r="9.5"
      />
      <path className={`${getResult()} ${getModifier(`2`)}`} d="M7,12 L17,12" />
    </React.Fragment>
  );
};
...
const Plus: React.FC = () => {
  ...
  return (
    <React.Fragment>
      <path className={`${getResult()} ${getModifier(`1`)}`} d="M12,4 L12,20" />
      <path className={`${getResult()} ${getModifier(`2`)}`} d="M4,12 L20,12" />
    </React.Fragment>
  );
};
...
const PlusRing: React.FC = () => {
  ...
  return (
    <React.Fragment>
      ...
      />
      <path className={`${getResult()} ${getModifier(`2`)}`} d="M7,12 L17,12" />
      <path className={`${getResult()} ${getModifier(`3`)}`} d="M12,7 L12,17" />
    </React.Fragment>
  );
};
