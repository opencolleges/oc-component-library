...
describe('<Textarea />', () => {
  ...
  it('Handles props.className', () => {
    expect(wrapper.getDOMNode().getAttribute('class')).toBe('oc-textarea');

    wrapper.setProps({ className: 'foo' });
    expect(wrapper.getDOMNode().getAttribute('class')).toBe('oc-textarea foo');
  ...
  it('Handles props.message', () => {
    expect(wrapper.find('span.oc-textarea__message').text()).toBe('');

    wrapper.setProps({ message: 'Qux' });
    expect(wrapper.find('span.oc-textarea__message').text()).toBe('Qux');

    wrapper.setProps({ message: '' });
    expect(wrapper.find('span.oc-textarea__message').text()).toBe('');

    wrapper.setProps({ message: 'Corge' });
    expect(wrapper.find('span.oc-textarea__message').text()).toBe('Corge');
  });
  ...
  it('Handles props.modifiers', () => {
    ...
    expect(wrapper.getDOMNode().getAttribute('class')).toBe(
      'oc-textarea oc-textarea--error'
    );

    wrapper.setProps({ modifiers: 'success' });
    expect(wrapper.getDOMNode().getAttribute('class')).toBe(
      'oc-textarea oc-textarea--success'
    );
  });
