    ...
    return (
      <div className={prefix('pagination')}>
        <ul className={prefix('pagination__list')}>
          <li
            className={prefix('pagination__item pagination__item--previous')}
            onClick={
              pagination.previousPage ? event => handlePrevious(event) : null
            }>
            <OCIcon modifiers="icon--arrow-left" />
        ...
        <ul className={prefix('pagination__list')}>
          <li
            className={prefix('pagination__item pagination__item--next')}
            onClick={pagination.nextPage ? event => handleNext(event) : null}>
            <OCIcon modifiers="icon--arrow-right" />
