...
export default class Text extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      error: _.includes(_.split(this.props.modifiers, ' '), 'text--error'),
      success: _.includes(_.split(this.props.modifiers, ' '), 'text--success'),
  ...
  render() {
    ...
    modifiers && (classNames += ` ${namespace(toModifier(modifiers, 'text'))}`);

    state.error && (classNames += ` ${namespace(toModifier('error', 'text'))}`);
    state.success &&
      (classNames += ` ${namespace(toModifier('success', 'text'))}`);
